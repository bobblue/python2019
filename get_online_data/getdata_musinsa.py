...
def request_url(url_sum):
    ...
    df = pd.DataFrame(data = {'brand': list_brand, 'product': list_product, 'price' : list_price, 'liked_cnt':list_liked_cnt, \
                            'review_cnt': list_review_cnt , 'star': list_review_star, 'url':list_each_url})
    return df
...
def main():
    ...
    df_all.to_excel('C:/Users/leevi/Downloads/무신사_크롤링_%s.xlsx' %(keyword), index=False)
    print('저장 완료! ')
