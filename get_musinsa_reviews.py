...
def main():
    dataset = pd.read_excel("C:/Users/leevi/Desktop/데상트_2월/무신사_크롤링/무신사_크롤링_운동화.xlsx", encoding='utf-8')
    ...
    df_all.to_excel('C:/Users/leevi/Downloads/무신사_크롤링_댓글.xlsx', index=False)
    print('저장 완료! ')
