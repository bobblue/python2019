...
def get_reviews(soup_data, goods_no):
    ...
    df = pd.DataFrame(data={'product_no': goods_no, 'date': date_list, 'title': title_list, 'content': content_list,
                            'option': option_list})
    # print(df)
    return df
...
def main():
    dataset = pd.read_excel("C:/Users/leevi/Desktop/데상트_2월/무신사_크롤링/무신사_크롤링_스니커즈.xlsx", encoding='utf-8')
    ...
    df_all.to_excel('C:/Users/leevi/Desktop/데상트_2월/무신사_크롤링/무신사_크롤링_댓글_스니커즈.xlsx', index=False)
    print('저장 완료! ')
